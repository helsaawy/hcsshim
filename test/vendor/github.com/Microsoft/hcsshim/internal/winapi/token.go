...
// );
//sys CreateRestrictedToken(existing windows.Handle, flags uint32, disableSidCount uint32, sidsToDisable *byte, deletePrivilegeCount uint32, privilegesToDelete *byte, restrictedSidCount uint32, sidsToRestrict *byte, newToken *windows.Handle) = securitybaseapi.CreateRestrictedToken

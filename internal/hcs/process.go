...
func (process *Process) waitBackground() {
	...
	ctx, span := otel.StartSpan(context.Background(), operation)
	defer span.End()
	span.SetAttributes(
...
func (process *Process) CloseStdin(ctx context.Context) (err error) {
	...
	ctx, span := otel.StartSpan(ctx, operation)
	defer func() { otel.SetSpanStatusAndEnd(span, err) }()
	span.SetAttributes(
		attribute.String("cid", process.SystemID()),
		attribute.Int64("pid", int64(process.processID)))
...
func (process *Process) CloseStdout(ctx context.Context) (err error) {
	ctx, span := otel.StartSpan(ctx, "hcs::Process::CloseStdout") //nolint:ineffassign,staticcheck
	defer func() { otel.SetSpanStatusAndEnd(span, err) }()
	span.SetAttributes(
		attribute.String("cid", process.SystemID()),
		attribute.Int64("pid", int64(process.processID)))
...
func (process *Process) CloseStderr(ctx context.Context) (err error) {
	ctx, span := otel.StartSpan(ctx, "hcs::Process::CloseStderr") //nolint:ineffassign,staticcheck
	defer func() { otel.SetSpanStatusAndEnd(span, err) }()
	span.SetAttributes(
		attribute.String("cid", process.SystemID()),
		attribute.Int64("pid", int64(process.processID)))
